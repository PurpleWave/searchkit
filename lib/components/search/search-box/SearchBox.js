...
var SearchBox = /** @class */ (function (_super) {
    ...
    SearchBox.prototype.render = function () {
        ...
        return (React.createElement("div", { className: block().state({ focused: this.state.focused }) },
            React.createElement("form", { style: { alignItems: 'baseline', flexDirection: 'row' }, onSubmit: this.onSubmit.bind(this) },
                React.createElement(Grid, { container: true, spacing: 8, alignItems: 'flex-end', style: { marginBottom: 12 } },
                    React.createElement(Grid, { item: true },
                        React.createElement(SearchIcon, null)),
                    React.createElement(Grid, { item: true, style: { flex: '1 0 auto' } },
                        React.createElement(TextField, { type: 'text', "data-qa": 'query', className: 'fullWidthInput', placeholder: this.props.placeholder, label: 'Search', value: this.getValue(), onFocus: this.setFocusState.bind(this, true), onBlur: this.setFocusState.bind(this, false), autoFocus: this.props.autofocus, onInput: this.onChange.bind(this) }))),
                React.createElement("input", { type: "submit", value: this.translate("searchbox.button"), className: block("action"), "data-qa": "submit" }),
                React.createElement(CircularProgress, { color: 'secondary', "data-qa": 'loader', style: { opacity: this.isLoading() ? 1 : 0 } }))));
    };
