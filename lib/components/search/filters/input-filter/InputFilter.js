...
var InputFilter = /** @class */ (function (_super) {
    ...
    InputFilter.prototype.render = function () {
        var _a = this.props, containerComponent = _a.containerComponent, title = _a.title, id = _a.id, _b = _a.type, type = _b === void 0 ? 'text' : _b;
        ...
        return core_1.renderComponent(containerComponent, {
            ...
            React.createElement("form", { onSubmit: this.onSubmit.bind(this) },
                React.createElement(TextField_1.default, { className: 'fullWidthInput', label: 'Search', value: value, onFocus: this.setFocusState.bind(this, true), onBlur: this.setFocusState.bind(this, false), autoFocus: false, onInput: this.onChange.bind(this), type: type }),
